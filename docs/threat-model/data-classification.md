...
| --- | --- | --- | --- | --- |
| Game and rank catalog | Public | Lobby; Identity/Profile retains a provisional local copy (see [ADR-005](../adr/ADR-005-profile-owned-catalog-seed.md)) | API responses and cache | Client-controlled rank ordinal or verification state |
