...
Historical snapshot preserved from `b6ba513`. Read only for a specific past
milestone; its current-state statements are historical, not execution guidance.
Start new work from [session-handoff.md](session-handoff.md).
