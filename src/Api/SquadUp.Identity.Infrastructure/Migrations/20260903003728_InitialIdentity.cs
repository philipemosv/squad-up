...
public partial class InitialIdentity : Migration
{
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        throw new NotSupportedException(
            "The initial Identity schema cannot be removed through an automatic downgrade. " +
            "Use a separately reviewed destructive migration with explicit human approval.");
    }
}
